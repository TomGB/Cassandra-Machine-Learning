...
% add a constant input node of one
...
delta_1=tridelta_1+delta_2'*a1; % Same size as Theta1_grad (25x401)
delta_2=tridelta_2+delta_3'*a2; % Same size as Theta2_grad (10x26)
